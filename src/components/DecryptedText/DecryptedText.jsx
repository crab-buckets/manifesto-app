...
export default function DecryptedText({
  ...
  // Kept in a ref, not a plain dependency, so a caller passing an inline arrow function (a new
  // reference on every one of ITS renders) doesn't tear down and restart the reveal interval below
  // mid-animation — that repeated restart was stalling the reveal indefinitely.
